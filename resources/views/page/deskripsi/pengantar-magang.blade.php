                ...
                <div class="mb-18">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="text-center mb-15">
                            <!--begin::Title-->
                            <h3 class="fs-2hx text-gray-900 mb-5">Surat Pengantar Magang</h3>
                            <!--end::Title-->
                            <!--begin::Text-->
                        </div>
                        @if(session('success'))
                    ...
                    @endif
                        <div class="pb-lg-5">
                            <!--begin::Title-->
                            <h2 class="fw-bold text-gray-900 mb-8">Langkah-langkah Pengajuan Surat Pengantar Magang
                                Mahasiswa :</h2>
                            <!--end::Title-->
                            <!--begin::List-->
                        ...
                        <a type="button" href="{{ url('deskripsi/pengantar-magang/buat') }}"
